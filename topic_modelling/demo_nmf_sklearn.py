...
def nmf_s_topic_model(csv_file_path, num_topics=5):
    # Read CSV file
    ...
    nmf_topic_matrix = nmf_model.fit_transform(tf)
    ...
    for idx, topic in enumerate(nmf_model.components_):
        ...
        topic_prob_sum = sum(topic)
        top_word_probabilities = [topic[i] / topic_prob_sum for i in top_words_indices]
